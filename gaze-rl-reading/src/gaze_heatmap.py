...
Converts numeric gaze features into a small image -- a project-specific
representation, loosely inspired by (but not a reproduction of) the
general idea, used in some eye-tracking work, of turning raw fixation
coordinates into a scanpath/heatmap image before feeding it to a CNN.
This is the piece that adds a CNN-based visual modeling component to the
project, alongside the RL agent -- not RL alone.
